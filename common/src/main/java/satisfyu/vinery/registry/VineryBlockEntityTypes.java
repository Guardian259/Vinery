...
public class VineryBlockEntityTypes {
    ...
    public static final RegistrySupplier<BlockEntityType<GrapeProducerBlockEntity>> GRAPE_BUSH_ENTITY = create("grape_bush", () -> {
        Block[] grapeProducers = {
                ObjectRegistry.GRAPE_BUSH.get(),
                ObjectRegistry.GRAPE_VINES.get(),
                ObjectRegistry.GRAPEVINE_LATTICE.get(),
                ObjectRegistry.GRAPEVINE_POST.get()
        };
        
        return BlockEntityType.Builder.of((d,e) -> {}, grapeProducers).build(null);
    });
    
    public static final RegistrySupplier<BlockEntityType<GrapeProducerBlockEntity>> GRAPE_VINE_ENTITY = create("grape_vine", () -> {
        Block[] grapeProducers = { ObjectRegistry.GRAPE_VINES.get(), ObjectRegistry.GRAPEVINE_LATTICE.get() };
        return BlockEntityType.Builder.of((pos, state) -> new GrapeProducerBlockEntity(), grapeProducers).build(null);
    });
